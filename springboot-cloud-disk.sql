...
CREATE TABLE `email_code`  (
  ...
  `code` varchar(5) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '邮箱验证码',
...
CREATE TABLE `file_info`  (
  ...
  `del_flat` tinyint(1) NULL DEFAULT 0 COMMENT '标记删除(0:正常 1:回收站)',
